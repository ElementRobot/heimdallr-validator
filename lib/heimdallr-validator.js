...
module.exports = {
     ...
     * given type. Returns an AssertionError if the packet violates the schema
     ...
     * @return {Error} error - AssertionError if packet violates schema or
     *     there is an invalid UUID or timestamp.
     */
    ...
    /**
     * Verifies that the data conforms to the schema. Returns an AssertionError
